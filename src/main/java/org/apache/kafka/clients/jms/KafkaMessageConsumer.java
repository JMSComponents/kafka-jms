...
import org.apache.kafka.clients.jms.consumer.CommitOnRevokedConsumerRebalanceListener;
import org.apache.kafka.clients.jms.exception.IllegalArgumentException;
import org.apache.kafka.clients.jms.exception.JmsExceptionSupport;
...
class KafkaMessageConsumer implements MessageConsumer, Runnable {
   ...
   private final org.apache.kafka.clients.jms.Destination destination;
