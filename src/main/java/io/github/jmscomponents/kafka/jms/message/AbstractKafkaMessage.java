...
import static io.github.jmscomponents.kafka.jms.message.JmsMessagePropertySupport.checkValidObject;
import static io.github.jmscomponents.kafka.jms.message.JmsMessagePropertySupport.convertPropertyTo;
...
public abstract class AbstractKafkaMessage<T> implements Message {
    ...
    public Destination getJMSReplyTo() throws JMSException {
        ...
        if (destinationName != null){
            destination = new io.github.jmscomponents.kafka.jms.Topic(destinationName);
        }
        return destination;
    }
